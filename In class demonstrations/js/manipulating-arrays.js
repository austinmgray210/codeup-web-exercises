...
(function () {
    ...
    // POP QUIZ: Whats the return of the function above?!
    // --- Lists all of the items individually within the array called.
    ...
    // cheeses.push("Pepper Jack Again", "Brie again");
    // console.log(cheeses);

    // cheeses.unshift("Cheddar again", "String again");
    // console.log(cheeses);
