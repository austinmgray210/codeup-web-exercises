...
var favoriteFoods = ["spaghetti", "ham & cheese sandwich", "pho", "fried spring rolls", "pork tenderloin"];
...
// for ( var i = 0; i < shapes.length; i++){
//     var myFavoriteShape = 'circle';
//     if  (shapes[i] === myFavoriteShape) {
//         alert("Hey a " + shapes[i] + ", that's my favorite shape!");
//     } else {
//         console.log(shapes[i]);
//     }
// }
